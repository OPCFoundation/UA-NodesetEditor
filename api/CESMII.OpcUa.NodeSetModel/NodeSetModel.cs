...
#nullable restore
    ...
    public class ObjectTypeModel : BaseTypeModel
    {
        ...
        public override BaseTypeModel SuperType { get; set; }
    }
    ...
    public class ReferenceTypeModel : BaseTypeModel
    {
        ...
        public int? SuperTypeId { get; set; } // For use with EF proxies, we avoid accessing the NodeModel.NodeSet property. Instead save the SubTypeId in a private _subTypeId variable
    }
    ...
    public class VariableTypeModel : BaseTypeModel, IVariableDataTypeInfo
    {
        ...
        public string ArrayDimensions { get; set; }
        public string Value { get; set; }
        public new VariableTypeModel SuperType { get; set; }
    }
